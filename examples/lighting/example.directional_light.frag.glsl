...
void main()
{
   const vec3 rgb = texture(material.diffuse, frag_texture_coordinates).rgb;

   // ambience
   const vec3 ambient = light.ambient * rgb;
   ...
   const vec3 diffuse = light.diffuse * diff * rgb;
   ...
   const vec3 specular = light.specular * spec * rgb;
